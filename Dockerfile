...
RUN microdnf update
RUN microdnf install -y  postgresql11-server postgresql11  postgresql11-contrib  python36  rsync findutils procps vim lsof iputils openssl curl fontconfig tar unzip 
