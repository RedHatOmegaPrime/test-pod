...
RUN wget  https://download.postgresql.org/pub/repos/yum/reporpms/EL-8-x86_64/pgdg-redhat-repo-latest.noarch.rpm && microdnf install -y pgdg-redhat-repo-latest.noarch.rpm
